...
const EPC = () => {
  ...
  return (
    <div className="epc-page">
      ...
      <section className="epc-intro-section" ref={introRef}>
      ...
      <section className="epc-value-section" ref={valueRef}>
      ...
      <section className="epc-multi-section" ref={multiRef}>
        <div className="container-custom h-full flex flex-col md:flex-row items-center gap-20">
      ...
      <section className="epc-multi-section" ref={detailRef}>
        <div className="container-custom h-full flex flex-col justify-center items-center text-center">
      ...
      <section className="epc-vmodel-section" ref={vmodelRef}>
        <div className="container-custom h-full flex flex-col lg:flex-row items-center gap-10">
      ...
      <section className="epc-discipline-section" ref={disciplineRef}>
        <div className="container-custom h-full flex flex-col justify-center py-20">
          <div className="mb-16">
